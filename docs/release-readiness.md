...
| Secret and direct-PII audit | PASS for current intended public tree | `scripts/audit_public_tree.py`: 192 text files, 3 secret + 3 PII rules, zero findings | Rerun after the sanitized real-results package is added |
